...
| | Start | End | Topic |
|:- |:- |:- |:- |
| **Lecture** | 6:30pm | 7:00pm | [[Merge-Sort]{.alg} &rarr;](#merging-two-sorted-lists-in-o(n-time)) |
| | 7:00pm | 7:30pm | [Object-Oriented Programming (OOP) &rarr;](#object-oriented-programming) |
| | 7:30pm | 8:00pm | [`LinkedList`: Lists from Scratch &rarr;](#core-data-structure-linkedlist) |
| **Break!** | 8:00pm | 8:10pm | |
| | 8:10pm | 8:30pm | [Other Data Structures = Fancy Linked Lists &rarr;](#onwards-and-upwards-fancier-algorithms) |
| | 8:30pm | 9:00pm | [`HashTable`: Logarithmic to *Constant* Efficiency 🤯 &rarr;](#hash-tables) |

: {tbl-colwidths="[12,12,12,64]"}

## Merging Two Sorted Lists in $\overline{O}(n)$ Time {.smaller .title-11 .crunch-figcaption .crunch-quarto-figure data-name="Merge Sort"}

![From @cormen_introduction_2001, pg. 37](images/merge.svg){.lightbox fig-align="center"}

## Merge Sort Walkthrough: The [Merge]{.alg} Procedure {.smaller .crunch-title .title-10 .crunch-p}

<center>

<iframe id="mergesortPRO_iframe" aria-label="mergesortPRO" src="https://opendsa-server.cs.vt.edu/ODSA/AV/Sorting/mergesortPRO.html?localMode=true&amp;module=Mergesort&amp;selfLoggingEnabled=false&amp;JXOP-debug=true&amp;JOP-lang=en&amp;JXOP-code=java&amp;JXOP-feedback=continuous&amp;JXOP-fixmode=fix&amp;scoringServerEnabled=false&amp;loggingServerEnabled=false&amp;threshold=0.9&amp;points=2.0&amp;required=False" class="crunch-p" height="600" data-showhide="show" style="width: 800px; height: 600px;">Your browser does not support iframes.</iframe>

</center>

## Complexity Analysis {.crunch-title .title-12 .text-90}

* [Interactive visualization!](https://opendsa-server.cs.vt.edu/ODSA/Books/Everything/html/Mergesort.html)
* More in-depth: see [Appendix Slides &rarr;](#appendix-merge-sort-runtime-analysis)
...
## Public, Protected, Private Attributes in Python {.smaller .crunch-title .title-10 .cols-clip}
...
## Key OOP Features #3-4: Inheritance, Polymorphism {.crunch-title .title-07 .crunch-ul .text-95}
...
## Appendix: Merge Sort Runtime Analysis {.title-09}
