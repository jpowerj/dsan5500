...
<tr class='new-unit'>
    <td><span data-qmd="**Unit 3**: Data Pipeline Orchestration"></span></td>
    <td>9</td>
...
<tr>
    ...
    <td><span data-qmd="*HW4 ({{< var hw4.title >}}) Due*"></span></td>
</tr>

<!-- Advanced Topics and Applications -->

<tr class='new-unit'>
    <td><span data-qmd="**Unit 5**: Final Project Topics and Applications"></span></td>
    <td>13</td>
    <td><span data-qmd="{{< var w13.date-md >}}"></span></td>
    <td><a href='./w13' target='_blank'><span data-qmd="{{< var w13.title >}}"></span></a></td>
</tr>
<tr>
    <td></td>
    <td>14</td>
    <td><span data-qmd="{{< var w14.date-md >}}"></span></td>
    <td><a href='./w14' target='_blank'><span data-qmd="{{< var w14.title >}}"></span></a></td>
</tr>
<tr>
    <td></td>
    <td>15</td>
    <td><span data-qmd="{{< var w15.date-md >}}"></span></td>
    <td><span data-qmd="{{< var w15.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td></td>
