...
digraph g {
	...
	subgraph clusterG0 {
		...
		subgraph clusterG1 {
				label="Stack"
                stvars[label = "{{<name1>cur_date|num_rows|filled|empty|num_cols|username|i|j|z}|{<addr1>0x88b6e369|<f1>13|<f2>0xb335c746|<f4>0x6164afe3|<f5>2|<f6>0xf7fc43e0|<f8>0x2a873f1c|<f9>0x88bb0093|<f10>314}}",shape = "record",fontname="Courier"]
		}
		subgraph clusterG2 {
				label="Heap"
          h1 [label="Date[2023-07-22]",fontname="Courier",penwidth=0]
          ...
          h5 [label=<<b>False</b>>,fontname="Courier",penwidth=0]
          h6 [label=<<b>None</b>>,fontname="Courier",penwidth=0]
          h7 [label=<<b>Singleton 0</b>>,fontname="Courier",penwidth=0]
          h8 [label=<<b>Singleton 2</b>>,fontname="Courier",penwidth=0]
		}
        "stvars":addr1 -> "h1":g5[style="solid",constraint=True] #,xlabel="View"]
        #$ "stvars":f4 -> "h1":g2[style="dashed",constraint=True] #,xlabel="View"]
        "stvars":f2 -> h4
...
https://kroki.io/graphviz/svg/eNqVk02P2jAQhs_wKyxvD60Ear4TUBKp2n6paquqW_XCopXjTEi6wUa2U6CE_17HwELVHBYfEr1-PY8nk5lhXi0EWZVogXZDpJcg7DGvRPL5u5GUMwpMCaIg-SEaGA5kkx0iaN1IBeKDpSMHg5pkUCf4Cyy52KKXbwptoVueA3q3AdqoirNXU_Rtq0rOsD7_H8Y2mCfQnSL0EZscLpdUv4mQM3MIJQjvdjEjS7BT2oiHXGfZsmb5IPhatkVV15C3sFyprdmlvJZtI0F0EW3V_mr_7NtdTPJc2Km1iaIsADeYtHFhp7arX47ezVzXp6EXaOlpGdiBRwroXD919DPQm0VYUM8FS8tIS4dEoVvYVMvJgZtZ1qQLsa3Utb39Ho9kSVbQfYAAykWORwVnqssrwbe8ERUIPNfl2PdVyvm3Uh-BrC4LVdpodrTe6oLMHMtxx1Y4dpx53zWjFbB1lasyseaGMjAQ9wlyjz9BUdzjZwUfU_BO0XGcpV3fxK-zNL0C4F8C3pNaXk0ILglfObsaEF4C7iq2qEFxhqxrOVE_x3kWp2uBEwkfmh9PTceicYpwaePpwp9Jta01QfK60q2kZ1bqia2YMiM7RzejzfFf_qxgjc_Z3bw4QwvvTHROxJzIEq5CnnlOxyu9HicwjtvjmBxKv8eZGCfocSLjhD2Ob5xoqGu4_wtgVnli