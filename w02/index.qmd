...
<tr>
    <td align="right">1</td>
    <td><code><span class='bold-code'>for</span> i = 2 <span class='bold-code'>to</span> n:</code></td>
    <td><span data-qmd="$c_1$"></span></td>
    <td><span data-qmd="$n$"></span></td>
</tr>
<tr>
    <td>2</td>
...
<tr>
    <td>3</td>
    <td><code style="color: #699754 !important;">&nbsp;&nbsp;# Insert A[i] into sorted subarray A[1:i-1]</code></td>
...
$$
T(n) = c_1n + c_2\widetilde{n} + c_4\widetilde{n} + c_5\sum_{i=2}^nt_i + c_6\sum_{i=2}^n(t_i - 1) + c_7\sum_{i=2}^n(t_i-1) + c_8\widetilde{n}
$$
